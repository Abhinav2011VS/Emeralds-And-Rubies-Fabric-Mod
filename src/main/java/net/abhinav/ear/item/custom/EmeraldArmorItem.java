...
import net.abhinav.ear.item.ModArmorMaterials;
    ...
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.EMERALD,
                            List.of(new StatusEffectInstance(StatusEffects.HASTE, 400, 25, false, false),
                                    new StatusEffectInstance(StatusEffects.JUMP_BOOST, 400, 5, false, false),
                                    new StatusEffectInstance(StatusEffects.ABSORPTION, 400, 25, false, false),
                                    new StatusEffectInstance(StatusEffects.REGENERATION, 400, 5, false, false),
                                    new StatusEffectInstance(StatusEffects.LUCK, 400, 10, false, false),
