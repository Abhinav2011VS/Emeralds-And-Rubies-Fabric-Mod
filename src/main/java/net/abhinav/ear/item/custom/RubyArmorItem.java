    ...
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.RUBY,
                            List.of(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400, 25, false, false),
                                    new StatusEffectInstance(StatusEffects.SLOW_FALLING, 400, 1, false,false)
                            )).build();

    public RubyArmorItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
